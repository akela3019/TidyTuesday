...
theme_custom <- theme(
  ...
  axis.text.x = element_text(angle = 40, hjust = 1, size = 9, color = "#373634"),
  axis.text.y = element_text(size = 9, color = "#373634")
)
...
p_region <- languages_summ %>%
  ...
  theme(plot.background = element_rect(fill = "#ecf0f1", color = NA),
        ...
        axis.text.x = element_text(angle = 45, hjust = 1, size = 9, color = "#373634"),
        axis.text.y = element_blank(),
        axis.ticks.y = element_blank(),
...
p_n_tweets <- afrisenti %>%
  ...
  theme(plot.background = element_rect(fill = "#ecf0f1", color = NA),
        ...
        plot.caption = element_text(size = 10.5, hjust = 3, vjust = 1,
                                    face = "bold", margin = margin(t = 5, l = 0)),
        panel.border = element_rect(color = "#ababab", fill = NA, linewidth = 0.3),
        strip.text.y.left = element_text(angle = 0, margin = margin(l = 1, r = 1), size = 8.5, color = "#373634"),
